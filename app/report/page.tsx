  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      if (email) {
        ...
        const formatedReports = recentReports?.map((report: any) => ({
          ...report,
          createdAt: report.createdAt.toISOString().split("T")[0],
        }));
    ...
    <div className="p-8 max-w-4xl mx-auto text-gray-800">
      ...
      >
        ...
        <Button
          ...
          disabled={!file || verifcationStatus === "verifiying"}
        >
          {verifcationStatus === "verifiying" ? (
            <>
              <Loader className="animate-spin mr-3 -ml-1 h-5 w-5 text-white" />
              Verifying...
            </>
          ) : (
            "Verify Waste"
        ...
        {verifcationStatus === "verified" && verificationResult && (
